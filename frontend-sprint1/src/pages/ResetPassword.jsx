...
import { Lock, AlertCircle, Loader2, Activity, KeyRound, ArrowLeft } from 'lucide-react';
...
const ResetPassword = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const result = await resetPassword(emailFromState, data.otp, data.newPassword);
            if (result.success) {
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="text-center lg:text-left mb-8">
                        ...
                        <p className="mt-2 text-sm text-slate-500">
                            Enter the OTP sent to <strong>{emailFromState}</strong>
                        </p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.otp ? 'border-red-300' : 'border-slate-300'} rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm tracking-widest`}
                                        placeholder="123456"
                                        maxLength={6}
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <input
                                        ...
                                        type="password"
                                        className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.newPassword ? 'border-red-300' : 'border-slate-300'} rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm`}
                                        placeholder="••••••••"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <input
                                        ...
                                        type="password"
                                        className={`appearance-none block w-full pl-10 pr-3 py-3 border ${errors.confirmPassword ? 'border-red-300' : 'border-slate-300'} rounded-xl shadow-sm placeholder-slate-400 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm`}
                                        placeholder="••••••••"
                                    />
                                </div>
