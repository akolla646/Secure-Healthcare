                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onRegisterSubmit)}>
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input id="name" {...register('name', { required: 'Full Name is required' })} type="text" className={`focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 sm:text-sm border-slate-300 rounded-md py-2 px-3 border ${errors.name ? 'border-red-300' : ''}`} placeholder="Dr. John Doe" />
                                </div>
